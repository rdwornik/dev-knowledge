...
def check_handoff_bundle_structure(repo_path: Path) -> list[Finding]:
    ...
    HISTORICAL v4 bundles. v5-bundle validation is owned by the deferred read-only teeth
    validator (`scripts/verify_handoff_probes.py`); until it lands, the manual probe-gate
    (HANDOFF_PROCESS.md §5) covers it.
