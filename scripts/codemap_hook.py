#!/usr/bin/env python3
"""pre-commit hook-source entry for the codemap tool (ADR-71).

Thin wrapper so `.pre-commit-hooks.yaml` can expose `scripts/codemap/` as an
...
from codemap.cli import main  # noqa: E402
