...
> **ARCHIVED 2026-05-29:** superseded by v4 at `protocols/HANDOFF_PROCESS.md`.
> Preserved per ADR-39 spirit + historical reference. v4 is a radical
> simplification (two phases, eight bundle files, files generated from source).
> The Q1–Q5 architectural concepts captured here (claims / scope / probe /
> manifest / ratification) are simplified into v4's interview + bundle format —
> see `protocols/HANDOFF_PROCESS.md` §Supersession chain. Do NOT edit this file;
> it is a frozen historical record.
