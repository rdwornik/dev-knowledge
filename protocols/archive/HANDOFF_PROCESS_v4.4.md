...
> **ARCHIVED 2026-06-11:** superseded by v5 at `protocols/HANDOFF_PROCESS.md`.
> Preserved per ADR-39 spirit + historical reference. v5 inverts the model from
> browser-delivered 8-file bundle to CC-owned lean residual + teeth-y forced
> primary-source read (ADR-82). Do NOT edit this file; it is a frozen historical record.
