...
| `handoff_probes` | PASS | 10 probe(s) bind to live state (2026-07-11-dev-knowledge-architect-phase-a0) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 41d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 41d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 41d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 41d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 41d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 41d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 41d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 41d old (> 30d cadence) |
