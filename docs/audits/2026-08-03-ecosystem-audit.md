...
**Date:** 2026-08-03  
**Generated:** 2026-08-03T08:43:20  
**Repos audited:** 6  
**Checks:** 244 total — 98 pass, 3 fail, 27 warn, 0 unavailable, 116 n/a
...
| `claude_md` | PASS | CLAUDE.md present (25887 chars) |
...
| `handoff_probes` | WARN | P0a skipped in 2026-08-01-dev-knowledge-architect-2: tool absent: grep |
| `handoff_probes` | WARN | P0b skipped in 2026-08-01-dev-knowledge-architect-2: tool absent: grep |
| `handoff_probes` | WARN | P0c skipped in 2026-08-01-dev-knowledge-architect-2: tool absent: sed |
| `handoff_probes` | WARN | P1a skipped in 2026-08-01-dev-knowledge-architect-2: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-08-01-dev-knowledge-architect-2: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-08-01-dev-knowledge-architect-2: tool absent: ls |
...
| `doc_code_coverage_drift` | PASS | all 38 ALL_CHECKS members covered (coverage_scope-annotated or exempt); none escape coverage_scope |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 62d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 62d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 62d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 62d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 62d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 62d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 62d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 62d old (> 30d cadence) |
...
- 6 repo(s) audited
- 98/244 checks passed
- **3 failure(s)** — route findings to repo owners
- 27 warning(s)
- 116 n/a (check not applicable to that repo)
