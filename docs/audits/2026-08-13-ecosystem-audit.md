...
**Date:** 2026-08-13  
**Generated:** 2026-08-13T11:38:13  
**Repos audited:** 6  
**Checks:** 293 total — 110 pass, 3 fail, 55 warn, 0 unavailable, 125 n/a
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#511 (7 dated block(s), 2907 chars (>= 3 dates & > 700, or > 1200)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#390 (1 dated block(s), 1282 chars (>= 3 dates & > 700, or > 1200)) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#508 (1 dated block(s), 1384 chars (>= 3 dates & > 700, or > 1200)) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#492 (5 dated block(s), 1489 chars (>= 3 dates & > 700, or > 1200)) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#513 (1 dated block(s), 2388 chars (>= 3 dates & > 700, or > 1200)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#369 (1 dated block(s), 1240 chars (>= 3 dates & > 700, or > 1200)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#383 (4 dated block(s), 1313 chars (>= 3 dates & > 700, or > 1200)) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 72d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-07-12 is 32d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 31d old (> 30d cadence) |
...
| `stale_worktrees` | WARN | 1 of 1 linked worktree(s) look unclosed (horizon 7d): vk/c35d-test [last commit 12d ago] - close them out per the /lane-integrate checklist, or say why they stay |
| `stale_worktrees` | PASS | git stash list is empty - no stashed work outliving its lane |
| `canonical_structure` | PASS | All present canonical files carry their required [U] spine headings |
| `handoff_version_stamp` | N/A | [n/a-reason:NOT-APPLICABLE] no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `amendment_coherence` | PASS | 0 coupled-surface version mention(s) coherent across 1 set(s) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 72d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 72d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 72d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 72d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 72d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 72d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 72d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 2 stale (edited since review): VISION.md: last_reviewed 2026-07-11 predates last edit 2026-07-12 - edited but not re-reviewed; ARCHITECTURE.md: last_reviewed 2026-07-11 predates last edit 2026-08-11 - edited but not re-reviewed | also 2 warn: CLAUDE.md: last_reviewed 2026-07-11 is 33d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-11 is 33d old (> 30d cadence) |
