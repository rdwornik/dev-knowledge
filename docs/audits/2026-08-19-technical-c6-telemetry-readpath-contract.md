# C6 — telemetry read-path design memo: dispatch contract (verbatim)

> **ADR-110 dispatch stamp.** This file is the lane's brief as received, committed unedited as
> the lane's first commit. It decides nothing on its own; the lane's output is
> `docs/audits/2026-08-19-technical-c6-telemetry-readpath.md`.
