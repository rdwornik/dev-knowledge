...
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-19 is 36d old (> 30d cadence) |
...
| `handoff_probes` | WARN | P1a skipped in 2026-07-23-dev-knowledge-architect: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-07-23-dev-knowledge-architect: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-07-23-dev-knowledge-architect: tool absent: ls |
