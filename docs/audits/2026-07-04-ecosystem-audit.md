...
**Date:** 2026-07-04  
**Generated:** 2026-07-04T14:40:39  
**Repos audited:** 5  
**Checks:** 147 total — 110 pass, 3 fail, 13 warn, 0 unavailable, 21 n/a
...
| `claude_md` | PASS | CLAUDE.md present (24951 chars) |
...
| `doc_claims` | WARN | 1 prose claim(s) drifted from repo state: pytest_collected@ecosystem/doc-counts.md (doc 1143 != actual 1174) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#244 (3 dated block(s), 1172 chars (>= 3 dates & > 700, or > 1200)) |
...
| `doc_code_coverage_drift` | PASS | all 28 ALL_CHECKS members covered (coverage_scope-annotated or exempt); none escape coverage_scope |
...
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-07-03 - edited but not re-reviewed | also 2 warn: VISION.md: last_reviewed 2026-06-02 is 32d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 32d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-06 - edited but not re-reviewed | also 2 warn: VISION.md: last_reviewed 2026-06-02 is 32d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 32d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 32d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 32d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 32d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 32d old (> 30d cadence) |
