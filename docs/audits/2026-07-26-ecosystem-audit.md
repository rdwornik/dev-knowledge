...
**Date:** 2026-07-26  
**Generated:** 2026-07-26T11:38:05  
**Repos audited:** 6  
**Checks:** 202 total — 149 pass, 3 fail, 27 warn, 0 unavailable, 23 n/a
...
| `handoff_probes` | WARN | P1a skipped in 2026-07-25-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-07-25-ai-council-architect: tool absent: sed |
| `handoff_probes` | WARN | P2 skipped in 2026-07-25-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P4 skipped in 2026-07-25-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P8 skipped in 2026-07-25-ai-council-architect: tool absent: ls |
| `handoff_probes` | WARN | P11 skipped in 2026-07-25-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P13 skipped in 2026-07-25-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P14 skipped in 2026-07-25-ai-council-architect: tool absent: grep |
...
| `fleet_parity` | PASS | fleet at parity -- AT-PARITY 174, PASS-declared 19, gate-ahead-declared 1, skipped-pre-deploy 2, stale-declaration 1 (blocking verdicts: 0) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 54d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 54d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 54d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 54d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 54d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 54d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 54d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 54d old (> 30d cadence) |
