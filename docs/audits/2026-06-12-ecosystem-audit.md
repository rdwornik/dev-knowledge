...
**Date:** 2026-06-12  
**Generated:** 2026-06-12T10:27:56  
**Repos audited:** 5  
**Checks:** 90 total — 87 pass, 2 fail, 1 warn, 0 unavailable
...
| `claude_md` | PASS | CLAUDE.md present (20553 chars) |
...
| `no_ff_merges` | PASS | no non-merge commits on main since 2026-06-11 (--no-ff rule, core-invariants #5; sanctioned automation excluded) |
