...
**Date:** 2026-07-16  
**Generated:** 2026-07-16T16:11:20  
**Repos audited:** 6  
**Checks:** 185 total — 138 pass, 3 fail, 21 warn, 0 unavailable, 23 n/a
...
| `claude_md` | PASS | CLAUDE.md present (31233 chars) |
...
| `handoff_probes` | PASS | 10 probe(s) bind to live state (2026-07-13-dev-knowledge-architect-a0-closed) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#332 (3 dated block(s), 933 chars (>= 3 dates & > 700, or > 1200)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#278 (3 dated block(s), 1508 chars (>= 3 dates & > 700, or > 1200)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#333 (3 dated block(s), 1136 chars (>= 3 dates & > 700, or > 1200)) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 44d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 44d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 44d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 44d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 44d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 44d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 44d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 44d old (> 30d cadence) |
