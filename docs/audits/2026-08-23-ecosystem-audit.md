...
**Date:** 2026-08-23  
**Generated:** 2026-08-23T11:02:08  
**Repos audited:** 6  
**Checks:** 320 total — 116 pass, 3 fail, 66 warn, 0 unavailable, 135 n/a
...
| `claude_md` | PASS | CLAUDE.md present (38557 chars) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#562 (2233 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#491 (1998 chars (declared ceiling 1320)) |
...
| `doc_rot` | WARN | history-accretion bloat: grooming-cadence BACKLOG#grooming-cadence (last groom 2026-07-30, 24d ago (> 21d cadence, ADR-41)) |
...
| `intake_tree_coherence` | PASS | intake residue carrier coherent (316 node(s), 19939 README.md byte(s)) |
...
| `journal_spine_anchor` | WARN | anchored by mention, not by record: 5de708f appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 9debc34 appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: e3f2571 appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 280e7f8 appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: c584a39 appears outside an explicit 'Anchors:' record line (+570 more) |
...
| `review_artifact_coverage` | WARN | 21 code-impact merge(s) since 2026-08-05 carry no linked review artifact: ad3e10d9 docs/d5-d6-ruling-execution-2026-08-22, e3f25716 fix/i3-single-flight-live-lock-2026-08-22, 62d072b5 fix/terra-cloud-wave-2026-08-22, 94821cba Merge lane 'claude/cloud-3-566-axis-lean, 23d72d51 docs/part-c-b3c-and-defer-acts-2026-08-22 (+16 more) -- advisory per the [#480] P3 ruling; the hard pre-push leg is deferred pending 0 false positives over two consecutive windows |
...
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-07-23 is 31d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 82d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-07-12 is 42d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 41d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-18 is 36d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 82d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 82d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 82d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 82d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 82d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 82d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 82d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 2 stale (edited since review): VISION.md: last_reviewed 2026-07-11 predates last edit 2026-07-12 - edited but not re-reviewed; ARCHITECTURE.md: last_reviewed 2026-07-11 predates last edit 2026-08-19 - edited but not re-reviewed | also 2 warn: CLAUDE.md: last_reviewed 2026-07-11 is 43d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-11 is 43d old (> 30d cadence) |
