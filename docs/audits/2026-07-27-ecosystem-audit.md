...
**Date:** 2026-07-27  
**Generated:** 2026-07-27T11:36:16  
**Repos audited:** 6  
**Checks:** 210 total — 154 pass, 3 fail, 30 warn, 0 unavailable, 23 n/a
...
| `handoff_probes` | WARN | P1a skipped in 2026-07-26-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-07-26-ai-council-architect: tool absent: sed |
| `handoff_probes` | WARN | P2 skipped in 2026-07-26-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P4 skipped in 2026-07-26-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P8 skipped in 2026-07-26-ai-council-architect: tool absent: ls |
| `handoff_probes` | WARN | P11 skipped in 2026-07-26-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P13 skipped in 2026-07-26-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P14 skipped in 2026-07-26-ai-council-architect: tool absent: grep |
| `reconciled_versions` | WARN | templates/CONTRIBUTING-md-template.md: malformed (reconciled_with not '<spec-id>@<version>') |
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#344 (3 dated block(s), 1753 chars (>= 3 dates & > 700, or > 1200)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#421 (2 dated block(s), 1655 chars (>= 3 dates & > 700, or > 1200)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#422 (3 dated block(s), 2023 chars (>= 3 dates & > 700, or > 1200)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#332 (4 dated block(s), 1137 chars (>= 3 dates & > 700, or > 1200)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#278 (3 dated block(s), 1516 chars (>= 3 dates & > 700, or > 1200)) |
...
| `doc_code_coverage_drift` | PASS | all 32 ALL_CHECKS members covered (coverage_scope-annotated or exempt); none escape coverage_scope |
...
| `routine_consumers` | PASS | 1 declared routine row(s) name a consumer and a consumption_path (live hooks/schedules out of scope — [#426]) |
...
| `vision_md` | PASS | VISION.md present; frontmatter keys: ['last_reviewed', 'owner', 'status', 'version'] |
| `adr38_baseline` | PASS | All ADR-38 universal governance baseline files present |
| `claude_md` | PASS | CLAUDE.md present (31715 chars) |
| `dot_prefix_discipline` | PASS | All root config files dot-prefixed or on ADR-59 exception list |
| `canonical_md_visibility` | PASS | Mandatory canonical files present + correctly cased: ['VISION.md', 'ARCHITECTURE.md', 'CLAUDE.md', 'BACKLOG.md', 'CONTRIBUTING.md', 'JOURNAL.md', 'LESSONS.md'] |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 55d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 55d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 55d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 55d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 55d old (> 30d cadence) |
