...
**Date:** 2026-08-20  
**Generated:** 2026-08-20T09:46:04  
**Repos audited:** 6  
**Checks:** 303 total — 117 pass, 3 fail, 48 warn, 0 unavailable, 135 n/a
...
| `handoff_probes` | WARN | P0a skipped in 2026-08-17-dev-knowledge-architect-3: tool absent: grep |
| `handoff_probes` | WARN | P0b skipped in 2026-08-17-dev-knowledge-architect-3: tool absent: grep |
| `handoff_probes` | WARN | P0c skipped in 2026-08-17-dev-knowledge-architect-3: tool absent: sed |
| `handoff_probes` | WARN | P1a skipped in 2026-08-17-dev-knowledge-architect-3: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-08-17-dev-knowledge-architect-3: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-08-17-dev-knowledge-architect-3: tool absent: ls |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#561 (2243 chars (declared ceiling 1320)) |
...
| `journal_spine_anchor` | WARN | anchored by mention, not by record: 5ef7aad appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 52a8fe8 appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 772755b appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 0ac71ea appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: a481242 appears outside an explicit 'Anchors:' record line (+463 more) |
...
| `review_artifact_coverage` | WARN | 11 code-impact merge(s) since 2026-08-05 carry no linked review artifact: 7aa7ddf5 docs/l2-integration, 696a68cd docs/batch-2-integration, f4a01f0e worktree-lane-a-533-leg2, 7a316976 worktree-lane-e-502-mutmut, e32093fd fix/533-oracle-pin-repoint (+6 more) -- advisory per the [#480] P3 ruling; the hard pre-push leg is deferred pending 0 false positives over two consecutive windows |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 79d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-07-12 is 39d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 38d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-18 is 33d old (> 30d cadence) |
...
| `stale_worktrees` | WARN | 1 of 1 linked worktree(s) look unclosed (horizon 7d): vk/c35d-test [last commit 19d ago] - close them out per the /lane-integrate checklist, or say why they stay |
| `stale_worktrees` | PASS | git stash list is empty - no stashed work outliving its lane |
| `canonical_structure` | PASS | All present canonical files carry their required [U] spine headings |
| `handoff_version_stamp` | N/A | [n/a-reason:NOT-APPLICABLE] no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `amendment_coherence` | PASS | 0 coupled-surface version mention(s) coherent across 1 set(s) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 79d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 79d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 79d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 79d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 79d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 79d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 79d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 2 stale (edited since review): VISION.md: last_reviewed 2026-07-11 predates last edit 2026-07-12 - edited but not re-reviewed; ARCHITECTURE.md: last_reviewed 2026-07-11 predates last edit 2026-08-19 - edited but not re-reviewed | also 2 warn: CLAUDE.md: last_reviewed 2026-07-11 is 40d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-11 is 40d old (> 30d cadence) |
