...
**Date:** 2026-07-17  
**Generated:** 2026-07-17T09:00:33  
**Repos audited:** 6  
**Checks:** 187 total — 137 pass, 3 fail, 24 warn, 0 unavailable, 23 n/a
...
| `claude_md` | PASS | CLAUDE.md present (31418 chars) |
...
| `handoff_probes` | WARN | P1a skipped in 2026-07-13-dev-knowledge-architect-a0-closed: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-07-13-dev-knowledge-architect-a0-closed: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-07-13-dev-knowledge-architect-a0-closed: tool absent: ls |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#328 (1 dated block(s), 1233 chars (>= 3 dates & > 700, or > 1200)) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#340 (1 dated block(s), 1325 chars (>= 3 dates & > 700, or > 1200)) |
...
| `vision_md` | PASS | VISION.md present; frontmatter keys: ['last_reviewed', 'owner', 'status', 'version'] |
| `adr38_baseline` | PASS | All ADR-38 universal governance baseline files present |
| `claude_md` | PASS | CLAUDE.md present (24176 chars) |
| `dot_prefix_discipline` | PASS | All root config files dot-prefixed or on ADR-59 exception list |
| `canonical_md_visibility` | PASS | Mandatory canonical files present + correctly cased: ['VISION.md', 'ARCHITECTURE.md', 'CLAUDE.md', 'BACKLOG.md', 'CONTRIBUTING.md', 'JOURNAL.md', 'LESSONS.md'] |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 45d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 45d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 45d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 45d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 45d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 45d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 45d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 45d old (> 30d cadence) |
