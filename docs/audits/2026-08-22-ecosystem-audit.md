...
**Date:** 2026-08-22  
**Generated:** 2026-08-22T09:09:01  
**Repos audited:** 6  
**Checks:** 314 total — 117 pass, 3 fail, 59 warn, 0 unavailable, 135 n/a
...
| `claude_md` | PASS | CLAUDE.md present (40218 chars) |
...
| `handoff_probes` | WARN | P0a skipped in 2026-08-20-dev-knowledge-architect-2: tool absent: grep |
| `handoff_probes` | WARN | P0b skipped in 2026-08-20-dev-knowledge-architect-2: tool absent: grep |
| `handoff_probes` | WARN | P0c skipped in 2026-08-20-dev-knowledge-architect-2: tool absent: sed |
| `handoff_probes` | WARN | P1a skipped in 2026-08-20-dev-knowledge-architect-2: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-08-20-dev-knowledge-architect-2: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-08-20-dev-knowledge-architect-2: tool absent: ls |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#559 (2860 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#529 (2001 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#565 (1529 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#539 (2101 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#563 (2081 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#568 (1671 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#562 (2027 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#491 (1785 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#566 (1825 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#561 (3169 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#567 (1746 chars (declared ceiling 1320)) |
| `doc_rot` | WARN | history-accretion bloat: grooming-cadence BACKLOG#grooming-cadence (last groom 2026-07-30, 23d ago (> 21d cadence, ADR-41)) |
...
| `intake_tree_coherence` | PASS | intake residue carrier coherent (315 node(s), 19825 README.md byte(s)) |
...
| `journal_spine_anchor` | WARN | anchored by mention, not by record: 5492909 appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 1f0067f appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 26dd32a appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: e00a6dc appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 99aef32 appears outside an explicit 'Anchors:' record line (+530 more) |
...
| `review_artifact_coverage` | WARN | 16 code-impact merge(s) since 2026-08-05 carry no linked review artifact: ba815bdf docs/batch1-integration-2026-08-21, 8e5d41fc worktree-lane-tel-run-id, 168f07b4 worktree-lane-554-cloud-provisioning, 01adf895 worktree-lane-539-ch8-codification, 54633041 worktree-flip-parallel (+11 more) -- advisory per the [#480] P3 ruling; the hard pre-push leg is deferred pending 0 false positives over two consecutive windows |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 81d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-07-12 is 41d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 40d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-18 is 35d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 81d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 81d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 81d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 81d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 81d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 81d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 81d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 2 stale (edited since review): VISION.md: last_reviewed 2026-07-11 predates last edit 2026-07-12 - edited but not re-reviewed; ARCHITECTURE.md: last_reviewed 2026-07-11 predates last edit 2026-08-19 - edited but not re-reviewed | also 2 warn: CLAUDE.md: last_reviewed 2026-07-11 is 42d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-11 is 42d old (> 30d cadence) |
