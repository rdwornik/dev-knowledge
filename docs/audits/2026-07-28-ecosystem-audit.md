...
**Date:** 2026-07-28  
**Generated:** 2026-07-28T10:03:45  
**Repos audited:** 6  
**Checks:** 220 total — 156 pass, 3 fail, 28 warn, 0 unavailable, 33 n/a
...
| `handoff_probes` | WARN | P1a skipped in 2026-07-27-dev-knowledge-architect: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-07-27-dev-knowledge-architect: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-07-27-dev-knowledge-architect: tool absent: ls |
...
| `doc_code_coverage_drift` | PASS | all 34 ALL_CHECKS members covered (coverage_scope-annotated or exempt); none escape coverage_scope |
...
| `silent_rule_ratchet` | PASS | live 428 <= baseline 428 under detector silent-rule-v4 (56 file(s) in scope) |
| `task_tree_coherence` | PASS | derived tasks/ tree coherent with BACKLOG.md (per-file + manifest + full reassembly) |
...
| `task_tree_coherence` | N/A | hub-only — tasks/ is a hub-derived tree |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 56d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 56d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 56d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 56d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 56d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 56d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 56d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 56d old (> 30d cadence) |
...
- 6 repo(s) audited
- 156/220 checks passed
- **3 failure(s)** — route findings to repo owners
- 28 warning(s)
- 33 n/a (check not applicable to that repo)
