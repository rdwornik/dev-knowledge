...
| `handoff_probes` | PASS | 11 probe(s) bind to live state (2026-07-27-dev-knowledge-architect) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#437 (2 dated block(s), 1314 chars (>= 3 dates & > 700, or > 1200)) |
