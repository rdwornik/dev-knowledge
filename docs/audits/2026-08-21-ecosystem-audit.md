...
| `doc_rot` | WARN | history-accretion bloat: grooming-cadence BACKLOG#grooming-cadence (last groom 2026-07-30, 22d ago (> 21d cadence, ADR-41)) |
...
| `journal_spine_anchor` | WARN | anchored by mention, not by record: 03aca46 appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 57a5d15 appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: da8f43a appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 13a61ee appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 4acce74 appears outside an explicit 'Anchors:' record line (+487 more) |
...
| `review_artifact_coverage` | WARN | 12 code-impact merge(s) since 2026-08-05 carry no linked review artifact: 54633041 worktree-flip-parallel, 7aa7ddf5 docs/l2-integration, 696a68cd docs/batch-2-integration, f4a01f0e worktree-lane-a-533-leg2, 7a316976 worktree-lane-e-502-mutmut (+7 more) -- advisory per the [#480] P3 ruling; the hard pre-push leg is deferred pending 0 false positives over two consecutive windows |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 80d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-07-12 is 40d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 39d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-18 is 34d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 80d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 80d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 80d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 80d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 80d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 80d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 80d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 2 stale (edited since review): VISION.md: last_reviewed 2026-07-11 predates last edit 2026-07-12 - edited but not re-reviewed; ARCHITECTURE.md: last_reviewed 2026-07-11 predates last edit 2026-08-19 - edited but not re-reviewed | also 2 warn: CLAUDE.md: last_reviewed 2026-07-11 is 41d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-11 is 41d old (> 30d cadence) |
