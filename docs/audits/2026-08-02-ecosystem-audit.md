...
**Date:** 2026-08-02  
**Generated:** 2026-08-02T21:04:36  
**Repos audited:** 6  
**Checks:** 239 total — 99 pass, 3 fail, 21 warn, 0 unavailable, 116 n/a
...
| `claude_md` | PASS | CLAUDE.md present (24787 chars) |
...
| `handoff_probes` | PASS | 14 probe(s) bind to live state (2026-08-01-dev-knowledge-architect-2) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 61d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 61d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 61d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 61d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 61d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 61d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 61d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 61d old (> 30d cadence) |
