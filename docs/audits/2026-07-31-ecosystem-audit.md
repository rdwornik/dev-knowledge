...
**Date:** 2026-07-31  
**Generated:** 2026-07-31T11:55:55  
**Repos audited:** 6  
**Checks:** 221 total — 159 pass, 3 fail, 21 warn, 0 unavailable, 38 n/a
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 59d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 59d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 59d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 59d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 59d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 59d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 59d old (> 30d cadence) |
...
- 6 repo(s) audited
- 159/221 checks passed
- **3 failure(s)** — route findings to repo owners
- 21 warning(s)
- 38 n/a (check not applicable to that repo)
