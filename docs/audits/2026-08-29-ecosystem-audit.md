...
**Date:** 2026-08-29  
**Generated:** 2026-08-29T13:10:51  
**Repos audited:** 6  
**Checks:** 460 total — 123 pass, 11 fail, 152 warn, 0 unavailable, 174 n/a
...
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-07-23 is 37d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-27 is 33d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-24 is 36d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 88d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-07-12 is 48d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 47d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-18 is 42d old (> 30d cadence) |
| `generated_artifact_freshness` | N/A | [n/a-reason:SUBJECT-ABSENT] output(s) not present in this repo — ecosystem/conformance.md, ecosystem/conformance.html |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 88d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 88d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 88d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 88d old (> 30d cadence) |
| `generated_artifact_freshness` | N/A | [n/a-reason:SUBJECT-ABSENT] output(s) not present in this repo — ecosystem/conformance.md, ecosystem/conformance.html |
| `generated_artifact_freshness` | WARN | audits-index: declared input(s) with no git history — scripts/gen_audit_index.py; freshness cannot be verified over a partial input set; regenerate + commit: uv run --locked python scripts/gen_audit_index.py --write |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 88d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 88d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 88d old (> 30d cadence) |
| `generated_artifact_freshness` | N/A | [n/a-reason:SUBJECT-ABSENT] output(s) not present in this repo — ecosystem/conformance.md, ecosystem/conformance.html |
| `generated_artifact_freshness` | WARN | audits-index: declared input(s) with no git history — scripts/gen_audit_index.py; freshness cannot be verified over a partial input set; regenerate + commit: uv run --locked python scripts/gen_audit_index.py --write |
...
- 6 repo(s) audited
- 123/460 checks passed
- **11 failure(s)** — route findings to repo owners
- 152 warning(s)
