...
**Date:** 2026-07-01  
**Generated:** 2026-07-01T09:00:24  
**Repos audited:** 5  
**Checks:** 134 total — 108 pass, 2 fail, 7 warn, 0 unavailable, 17 n/a
...
| `handoff_probes` | WARN | P1a skipped in 2026-06-27-dev-knowledge-architect: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-06-27-dev-knowledge-architect: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-06-27-dev-knowledge-architect: tool absent: ls |
...
| `safe_removal` | PASS | no scripts/*.py module removal in the diff |
| `deployed_methodology_version` | N/A | ai-council: unset -- no methodology release deployed yet (deploy-runbook will populate; ADR-91) |
...
- 5 repo(s) audited
- 108/134 checks passed
- **2 failure(s)** — route findings to repo owners
- 7 warning(s)
- 17 n/a (check not applicable to that repo)
