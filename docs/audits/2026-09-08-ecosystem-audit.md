...
**Date:** 2026-09-08  
**Generated:** 2026-09-08T09:06:59  
**Repos audited:** 6  
**Checks:** 473 total — 137 pass, 8 fail, 147 warn, 0 unavailable, 181 n/a
...
| `doc_claims` | WARN | 1 prose claim(s) drifted from repo state: pytest_collected@ecosystem/doc-counts.md (doc 5384 != actual 5330) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#row-length (76 of 229 rows over the declared ceiling 1320 chars (LONG, not rot: a row may be long for a ruled reason); longest 5438 chars; row-length p50/p75/p90 over all 229 rows = 1269/1594/2297 chars; trend: +5 vs previous run (71 -> 76)) |
| `doc_rot` | WARN | history-accretion bloat: grooming-cadence BACKLOG#grooming-cadence (last groom 2026-07-30, 40d ago (> 21d cadence, ADR-41)) |
...
| `review_artifact_coverage` | WARN | 126 code-impact merge(s) since 2026-08-05 carry no linked review artifact: 837e49fc worktree-c2-living-docs-hygiene, dec60004 worktree-c4-handoff-preflight-rows, a415d720 chore/arm-prompts-guard-pretooluse, e02a442d worktree-filings-n3, 6ebf44a8 fix/audit-rule-marker-reflow-2026-09-07 (+121 more) -- advisory per the [#480] P3 ruling; the hard pre-push leg is deferred pending 0 false positives over two consecutive windows |
...
| `proof_layer` | WARN | test_review_artifact_coverage.py gates 1 test(s) behind a function-level skipif on 'git' — a proof that can be skipped on the machine that breaks the property is not a mechanism. Move the property that cannot be skipped OUT from behind the guard, or propagate the skip predicate into a reporting surface so a skipped proof renders as not-proven (sweep sections 9.2 and 9.6) |
| `proof_layer` | WARN | test_review_artifact_coverage.py gates 1 test(s) behind a function-level skipif on 'git' — a proof that can be skipped on the machine that breaks the property is not a mechanism. Move the property that cannot be skipped OUT from behind the guard, or propagate the skip predicate into a reporting surface so a skipped proof renders as not-proven (sweep sections 9.2 and 9.6) |
| `funnel_lifecycle` | PASS | 78 live + 12 archived intake(s), 91 live ADR(s), 369 row(s): no terminal object left in a live home, every ACCEPTED doc still owns an open row, and all 33 row(s) landed on/after 2026-08-27 carry resolving provenance |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | ARCHITECTURE.md: last_reviewed 2026-07-12 is 58d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 57d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-18 is 52d old (> 30d cadence); docs/handoffs/README.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/ESSENTIALS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/SESSION_SETUP.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/AI_COUNCIL_PROCESS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/DEFINITION_OF_DONE.md: absent (registered but presence-optional here) - reported, not skipped silently |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | ARCHITECTURE.md: last_reviewed 2026-06-02 is 98d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 98d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 98d old (> 30d cadence); docs/handoffs/README.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/ESSENTIALS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/SESSION_SETUP.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/AI_COUNCIL_PROCESS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/DEFINITION_OF_DONE.md: absent (registered but presence-optional here) - reported, not skipped silently |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 7 warn: ARCHITECTURE.md: last_reviewed 2026-06-02 is 98d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 98d old (> 30d cadence); docs/handoffs/README.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/ESSENTIALS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/SESSION_SETUP.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/AI_COUNCIL_PROCESS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/DEFINITION_OF_DONE.md: absent (registered but presence-optional here) - reported, not skipped silently |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | CONTRIBUTING.md: last_reviewed 2026-07-11 is 59d old (> 30d cadence); docs/handoffs/README.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/ESSENTIALS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/SESSION_SETUP.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/AI_COUNCIL_PROCESS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/DEFINITION_OF_DONE.md: absent (registered but presence-optional here) - reported, not skipped silently |
