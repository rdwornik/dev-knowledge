...
**Date:** 2026-08-15  
**Generated:** 2026-08-15T10:46:49  
**Repos audited:** 6  
**Checks:** 333 total — 114 pass, 3 fail, 81 warn, 0 unavailable, 135 n/a
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 74d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-07-12 is 34d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 33d old (> 30d cadence) |
...
| `stale_worktrees` | WARN | 1 of 1 linked worktree(s) look unclosed (horizon 7d): vk/c35d-test [last commit 14d ago] - close them out per the /lane-integrate checklist, or say why they stay |
| `stale_worktrees` | PASS | git stash list is empty - no stashed work outliving its lane |
| `canonical_structure` | PASS | All present canonical files carry their required [U] spine headings |
| `handoff_version_stamp` | N/A | [n/a-reason:NOT-APPLICABLE] no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `amendment_coherence` | PASS | 0 coupled-surface version mention(s) coherent across 1 set(s) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 74d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 74d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 74d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 74d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 74d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 74d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 74d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 2 stale (edited since review): VISION.md: last_reviewed 2026-07-11 predates last edit 2026-07-12 - edited but not re-reviewed; ARCHITECTURE.md: last_reviewed 2026-07-11 predates last edit 2026-08-13 - edited but not re-reviewed | also 2 warn: CLAUDE.md: last_reviewed 2026-07-11 is 35d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-11 is 35d old (> 30d cadence) |
...
- 6 repo(s) audited
- 114/333 checks passed
- **3 failure(s)** — route findings to repo owners
- 81 warning(s)
- 135 n/a (check not applicable to that repo)
