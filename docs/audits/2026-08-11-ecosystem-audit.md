...
**Date:** 2026-08-11  
**Generated:** 2026-08-11T11:16:42  
**Repos audited:** 6  
**Checks:** 282 total — 110 pass, 3 fail, 44 warn, 0 unavailable, 125 n/a
...
| `claude_md` | PASS | CLAUDE.md present (34239 chars) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#360 (4 dated block(s), 1384 chars (>= 3 dates & > 700, or > 1200)) |
...
| `silent_rule_ratchet` | PASS | live 439 <= baseline 441 under detector silent-rule-v4 (57 file(s) in scope); 2 below baseline — ratchet-down available |
...
| `intake_tree_coherence` | PASS | intake residue carrier coherent (266 node(s), 15927 README.md byte(s)) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 70d old (> 30d cadence) |
...
| `stale_worktrees` | WARN | 1 of 1 linked worktree(s) look unclosed (horizon 7d): vk/c35d-test [last commit 10d ago] - close them out per the /lane-integrate checklist, or say why they stay |
| `stale_worktrees` | PASS | git stash list is empty - no stashed work outliving its lane |
| `canonical_structure` | PASS | All present canonical files carry their required [U] spine headings |
| `handoff_version_stamp` | N/A | [n/a-reason:NOT-APPLICABLE] no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `amendment_coherence` | PASS | 0 coupled-surface version mention(s) coherent across 1 set(s) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 70d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 70d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 70d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 70d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 70d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 70d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 70d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 2 stale (edited since review): VISION.md: last_reviewed 2026-07-11 predates last edit 2026-07-12 - edited but not re-reviewed; ARCHITECTURE.md: last_reviewed 2026-07-11 predates last edit 2026-08-07 - edited but not re-reviewed | also 2 warn: CLAUDE.md: last_reviewed 2026-07-11 is 31d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-11 is 31d old (> 30d cadence) |
