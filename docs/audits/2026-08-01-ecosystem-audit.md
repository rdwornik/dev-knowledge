...
**Date:** 2026-08-01  
**Generated:** 2026-08-01T11:38:06  
**Repos audited:** 6  
**Checks:** 232 total — 158 pass, 4 fail, 27 warn, 0 unavailable, 43 n/a
...
| `handoff_probes` | WARN | P0a skipped in 2026-08-01-dev-knowledge-architect: tool absent: grep |
| `handoff_probes` | WARN | P0b skipped in 2026-08-01-dev-knowledge-architect: tool absent: grep |
| `handoff_probes` | WARN | P0c skipped in 2026-08-01-dev-knowledge-architect: tool absent: sed |
| `handoff_probes` | WARN | P1a skipped in 2026-08-01-dev-knowledge-architect: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-08-01-dev-knowledge-architect: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-08-01-dev-knowledge-architect: tool absent: ls |
...
| `doc_code_coverage_drift` | PASS | all 36 ALL_CHECKS members covered (coverage_scope-annotated or exempt); none escape coverage_scope |
...
| `silent_rule_ratchet` | FAIL | raise-guard INDETERMINATE: the baseline on the integration ref exists but is unreadable or malformed, so a raise cannot be ruled out (live 439, committed 441) |
...
| `intake_tree_coherence` | PASS | intake residue carrier coherent (256 node(s), 14465 README.md byte(s)) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 60d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 60d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 60d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 60d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 60d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 60d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 60d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 60d old (> 30d cadence) |
...
- 6 repo(s) audited
- 158/232 checks passed
- **4 failure(s)** — route findings to repo owners
- 27 warning(s)
- 43 n/a (check not applicable to that repo)
