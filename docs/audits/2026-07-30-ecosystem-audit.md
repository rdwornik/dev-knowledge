...
**Date:** 2026-07-30  
**Generated:** 2026-07-30T10:11:35  
**Repos audited:** 6  
**Checks:** 222 total — 156 pass, 3 fail, 30 warn, 0 unavailable, 33 n/a
...
| `claude_md` | PASS | CLAUDE.md present (40966 chars) |
...
| `handoff_probes` | WARN | P1a skipped in 2026-07-31-dev-knowledge-architect: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-07-31-dev-knowledge-architect: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-07-31-dev-knowledge-architect: tool absent: ls |
...
| `doc_rot` | WARN | history-accretion bloat: grooming-cadence BACKLOG#grooming-cadence (last groom 2026-07-08, 22d ago (> 21d cadence, ADR-41)) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 58d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 58d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 58d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 58d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 58d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 58d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 58d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 58d old (> 30d cadence) |
