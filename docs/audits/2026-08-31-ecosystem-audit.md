...
| `doc_rot` | WARN | history-accretion bloat: grooming-cadence BACKLOG#grooming-cadence (last groom 2026-07-30, 32d ago (> 21d cadence, ADR-41)) |
...
| `funnel_lifecycle` | WARN | ready-past-threshold: docs/intake/2026-07-16-satellite-onboarding-prompts.md -- READY for 46 days (document age), past the ruled 30-day threshold at protocols/FUNNEL_LIFECYCLE.md:316, and carries no review-date: |
...
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-07-23 is 39d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-27 is 35d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-24 is 38d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 90d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-07-12 is 50d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 49d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-18 is 44d old (> 30d cadence) |
| `generated_artifact_freshness` | N/A | [n/a-reason:SUBJECT-ABSENT] output(s) not present in this repo — ecosystem/conformance.md, ecosystem/conformance.html |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 90d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 90d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 90d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 90d old (> 30d cadence) |
| `generated_artifact_freshness` | N/A | [n/a-reason:SUBJECT-ABSENT] output(s) not present in this repo — ecosystem/conformance.md, ecosystem/conformance.html |
| `generated_artifact_freshness` | WARN | audits-index: declared input(s) with no git history — scripts/gen_audit_index.py; freshness cannot be verified over a partial input set; regenerate + commit: uv run --locked python scripts/gen_audit_index.py --write |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 90d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 90d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 90d old (> 30d cadence) |
| `generated_artifact_freshness` | N/A | [n/a-reason:SUBJECT-ABSENT] output(s) not present in this repo — ecosystem/conformance.md, ecosystem/conformance.html |
| `generated_artifact_freshness` | WARN | audits-index: declared input(s) with no git history — scripts/gen_audit_index.py; freshness cannot be verified over a partial input set; regenerate + commit: uv run --locked python scripts/gen_audit_index.py --write |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 3 stale (edited since review): VISION.md: last_reviewed 2026-07-11 predates last edit 2026-07-12 - edited but not re-reviewed; ARCHITECTURE.md: last_reviewed 2026-07-11 predates last edit 2026-08-19 - edited but not re-reviewed; CLAUDE.md: last_reviewed 2026-07-11 predates last edit 2026-08-29 - edited but not re-reviewed | also 1 warn: CONTRIBUTING.md: last_reviewed 2026-07-11 is 51d old (> 30d cadence) |
| `generated_artifact_freshness` | N/A | [n/a-reason:SUBJECT-ABSENT] output(s) not present in this repo — ecosystem/conformance.md, ecosystem/conformance.html |
| `generated_artifact_freshness` | N/A | [n/a-reason:SUBJECT-ABSENT] output(s) not present in this repo — docs/audits/README.md |
