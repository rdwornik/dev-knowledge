...
**Date:** 2026-06-06  
**Generated:** 2026-06-06T00:02:23  
**Repos audited:** 5  
**Checks:** 65 total — 65 pass, 0 fail, 0 warn, 0 unavailable
...
| `claude_md` | PASS | CLAUDE.md present (18541 chars) |
...
| `handoff_bundle_structure` | PASS | 8 stamped v4 bundle(s) valid (structure + sections + budgets) |
