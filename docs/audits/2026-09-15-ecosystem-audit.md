...
**Date:** 2026-09-15  
**Generated:** 2026-09-15T09:09:50  
**Repos audited:** 6  
**Checks:** 621 total — 135 pass, 9 fail, 296 warn, 0 unavailable, 181 n/a
...
| `generated_artifact_freshness` | PASS | audits-index: 0d stale (baseline 0d) — docs/audits/README.md committed 2026-09-15, newest input docs/audits committed 2026-09-15 |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-row-length BACKLOG#row-length (173 of 347 rows over the declared ceiling 1320 chars (LONG, not rot: a row may be long for a ruled reason); longest 13677 chars; row-length p50/p75/p90 over all 347 rows = 1318/2836/4085 chars; trend: +28 vs previous run (145 -> 173)) |
...
| `silent_rule_ratchet` | PASS | live 430 <= baseline 447 under detector silent-rule-v5 (69 file(s) in scope); 17 below baseline — ratchet-down available |
...
| `intake_tree_coherence` | PASS | intake residue carrier coherent (390 node(s), 29459 README.md byte(s)) |
...
| `journal_spine_anchor` | WARN | anchored by mention, not by record: 901d1ab appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 627297c appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: a9b4152 appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 2830d3d appears outside an explicit 'Anchors:' record line; anchored by mention, not by record: 7035650 appears outside an explicit 'Anchors:' record line (+1023 more) |
...
| `review_artifact_coverage` | WARN | 164 code-impact merge(s) since 2026-08-05 carry no linked review artifact: 5bbc3be6 worktree-lane-z-4-non-claude-execution, 2830d3d6 worktree-lane-z-0-quality-requirements, 4f4186a6 z-746, ef1a91cb worktree-lane-y-752-declared-model-runs, b864e7d0 worktree-lane-y-751-cost-in-money (+159 more) -- advisory per the [#480] P3 ruling; the hard pre-push leg is deferred pending 0 false positives over two consecutive windows |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | ARCHITECTURE.md: last_reviewed 2026-07-12 is 65d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 64d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-18 is 59d old (> 30d cadence); docs/handoffs/README.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/SESSION_SETUP.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/AI_COUNCIL_PROCESS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/DEFINITION_OF_DONE.md: absent (registered but presence-optional here) - reported, not skipped silently |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | ARCHITECTURE.md: last_reviewed 2026-06-02 is 105d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 105d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 105d old (> 30d cadence); docs/handoffs/README.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/SESSION_SETUP.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/AI_COUNCIL_PROCESS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/DEFINITION_OF_DONE.md: absent (registered but presence-optional here) - reported, not skipped silently |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 6 warn: ARCHITECTURE.md: last_reviewed 2026-06-02 is 105d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 105d old (> 30d cadence); docs/handoffs/README.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/SESSION_SETUP.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/AI_COUNCIL_PROCESS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/DEFINITION_OF_DONE.md: absent (registered but presence-optional here) - reported, not skipped silently |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | CONTRIBUTING.md: last_reviewed 2026-07-11 is 66d old (> 30d cadence); docs/handoffs/README.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/SESSION_SETUP.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/AI_COUNCIL_PROCESS.md: absent (registered but presence-optional here) - reported, not skipped silently; protocols/DEFINITION_OF_DONE.md: absent (registered but presence-optional here) - reported, not skipped silently |
...
| `stale_worktrees` | WARN | 4 of 4 linked worktree(s) look unclosed (horizon 7d): fix/cloud-models-fail-fast [last commit 20d ago]; feat/cloud-models [last commit 20d ago]; fix/sanitise-external-text [last commit 20d ago]; fix/check-advisory-unowned-path [last commit 20d ago] - close them out per the /lane-integrate checklist, or say why they stay |
| `stale_worktrees` | PASS | git stash list is empty - no stashed work outliving its lane |
| `canonical_structure` | PASS | All present canonical files carry their required [U] spine headings |
| `handoff_version_stamp` | N/A | [n/a-reason:NOT-APPLICABLE] no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `amendment_coherence` | PASS | 0 coupled-surface version mention(s) coherent across 1 set(s) |
