...
**Date:** 2026-08-12  
**Generated:** 2026-08-12T09:56:10  
**Repos audited:** 6  
**Checks:** 290 total — 110 pass, 3 fail, 52 warn, 0 unavailable, 125 n/a
...
| `claude_md` | PASS | CLAUDE.md present (38472 chars) |
...
| `handoff_probes` | WARN | P0a skipped in 2026-08-10-dev-knowledge-architect-2: tool absent: grep |
| `handoff_probes` | WARN | P0b skipped in 2026-08-10-dev-knowledge-architect-2: tool absent: grep |
| `handoff_probes` | WARN | P0c skipped in 2026-08-10-dev-knowledge-architect-2: tool absent: sed |
| `handoff_probes` | WARN | P1a skipped in 2026-08-10-dev-knowledge-architect-2: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-08-10-dev-knowledge-architect-2: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-08-10-dev-knowledge-architect-2: tool absent: ls |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#505 (3 dated block(s), 1914 chars (>= 3 dates & > 700, or > 1200)) |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#360 (7 dated block(s), 1857 chars (>= 3 dates & > 700, or > 1200)) |
| `doc_rot` | WARN | history-accretion bloat: file-budget CLAUDE.md#size (202 lines (self-declared budget 200)) |
...
| `intake_tree_coherence` | PASS | intake residue carrier coherent (266 node(s), 15928 README.md byte(s)) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 71d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-07-12 is 31d old (> 30d cadence) |
...
| `stale_worktrees` | WARN | 1 of 1 linked worktree(s) look unclosed (horizon 7d): vk/c35d-test [last commit 11d ago] - close them out per the /lane-integrate checklist, or say why they stay |
| `stale_worktrees` | PASS | git stash list is empty - no stashed work outliving its lane |
| `canonical_structure` | PASS | All present canonical files carry their required [U] spine headings |
| `handoff_version_stamp` | N/A | [n/a-reason:NOT-APPLICABLE] no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `amendment_coherence` | PASS | 0 coupled-surface version mention(s) coherent across 1 set(s) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 71d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 71d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 71d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 71d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 71d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 71d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 71d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 2 stale (edited since review): VISION.md: last_reviewed 2026-07-11 predates last edit 2026-07-12 - edited but not re-reviewed; ARCHITECTURE.md: last_reviewed 2026-07-11 predates last edit 2026-08-11 - edited but not re-reviewed | also 2 warn: CLAUDE.md: last_reviewed 2026-07-11 is 32d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-11 is 32d old (> 30d cadence) |
