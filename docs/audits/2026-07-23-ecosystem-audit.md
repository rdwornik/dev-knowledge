...
**Date:** 2026-07-23  
**Generated:** 2026-07-23T09:01:14  
**Repos audited:** 6  
**Checks:** 201 total — 148 pass, 3 fail, 27 warn, 0 unavailable, 23 n/a
...
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-19 is 34d old (> 30d cadence) |
...
| `handoff_probes` | WARN | P1a skipped in 2026-07-21-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-07-21-ai-council-architect: tool absent: sed |
| `handoff_probes` | WARN | P2 skipped in 2026-07-21-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P4 skipped in 2026-07-21-ai-council-architect: tool absent: grep |
| `handoff_probes` | WARN | P8 skipped in 2026-07-21-ai-council-architect: tool absent: ls |
| `handoff_probes` | WARN | P12 skipped in 2026-07-21-ai-council-architect: tool absent: grep |
...
| `vision_md` | PASS | VISION.md present; frontmatter keys: ['last_reviewed', 'owner', 'status', 'version'] |
| `adr38_baseline` | PASS | All ADR-38 universal governance baseline files present |
| `claude_md` | PASS | CLAUDE.md present (29423 chars) |
| `dot_prefix_discipline` | PASS | All root config files dot-prefixed or on ADR-59 exception list |
| `canonical_md_visibility` | PASS | Mandatory canonical files present + correctly cased: ['VISION.md', 'ARCHITECTURE.md', 'CLAUDE.md', 'BACKLOG.md', 'CONTRIBUTING.md', 'JOURNAL.md', 'LESSONS.md'] |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 51d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 51d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 51d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 51d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 51d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | no docs/handoffs/ — nothing to validate |
| `handoff_tag_canonicity` | N/A | no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 51d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 51d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 51d old (> 30d cadence) |
