...
**Date:** 2026-08-14  
**Generated:** 2026-08-14T11:09:48  
**Repos audited:** 6  
**Checks:** 324 total — 113 pass, 3 fail, 78 warn, 0 unavailable, 130 n/a
...
| `doc_claims` | WARN | 1 prose claim(s) drifted from repo state: pytest_collected@ecosystem/doc-counts.md (doc 2889 != actual 2890) |
...
| `handoff_probes` | WARN | P0a skipped in 2026-08-12-dev-knowledge-architect: tool absent: grep |
| `handoff_probes` | WARN | P0b skipped in 2026-08-12-dev-knowledge-architect: tool absent: grep |
| `handoff_probes` | WARN | P0c skipped in 2026-08-12-dev-knowledge-architect: tool absent: sed |
| `handoff_probes` | WARN | P1a skipped in 2026-08-12-dev-knowledge-architect: tool absent: grep |
| `handoff_probes` | WARN | P1b skipped in 2026-08-12-dev-knowledge-architect: tool absent: sed |
| `handoff_probes` | WARN | P8 skipped in 2026-08-12-dev-knowledge-architect: tool absent: ls |
...
| `doc_rot` | WARN | history-accretion bloat: backlog-accretion BACKLOG#525 (6 dated block(s), 1915 chars (>= 3 dates & > 700, or > 1200)) |
...
| `doc_code_coverage_drift` | PASS | all 42 ALL_CHECKS members covered (coverage_scope-annotated or exempt); none escape coverage_scope |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 73d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-07-12 is 33d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-07-13 is 32d old (> 30d cadence) |
...
| `stale_worktrees` | WARN | 1 of 1 linked worktree(s) look unclosed (horizon 7d): vk/c35d-test [last commit 13d ago] - close them out per the /lane-integrate checklist, or say why they stay |
| `stale_worktrees` | PASS | git stash list is empty - no stashed work outliving its lane |
| `canonical_structure` | PASS | All present canonical files carry their required [U] spine headings |
| `handoff_version_stamp` | N/A | [n/a-reason:NOT-APPLICABLE] no protocols/HANDOFF_PROCESS.md — nothing to validate |
| `amendment_coherence` | PASS | 0 coupled-surface version mention(s) coherent across 1 set(s) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | WARN | VISION.md: last_reviewed 2026-06-02 is 73d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 73d old (> 30d cadence); CLAUDE.md: last_reviewed 2026-06-02 is 73d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 73d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 1 stale (edited since review): CLAUDE.md: last_reviewed 2026-06-02 predates last edit 2026-06-08 - edited but not re-reviewed | also 3 warn: VISION.md: last_reviewed 2026-06-02 is 73d old (> 30d cadence); ARCHITECTURE.md: last_reviewed 2026-06-02 is 73d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-06-02 is 73d old (> 30d cadence) |
...
| `handoff_bundle_structure` | N/A | [n/a-reason:NOT-APPLICABLE] no docs/handoffs/ — nothing to validate |
| `canonical_freshness` | FAIL | 2 stale (edited since review): VISION.md: last_reviewed 2026-07-11 predates last edit 2026-07-12 - edited but not re-reviewed; ARCHITECTURE.md: last_reviewed 2026-07-11 predates last edit 2026-08-13 - edited but not re-reviewed | also 2 warn: CLAUDE.md: last_reviewed 2026-07-11 is 34d old (> 30d cadence); CONTRIBUTING.md: last_reviewed 2026-07-11 is 34d old (> 30d cadence) |
...
- 6 repo(s) audited
- 113/324 checks passed
- **3 failure(s)** — route findings to repo owners
- 78 warning(s)
- 130 n/a (check not applicable to that repo)
