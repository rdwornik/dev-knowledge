...
## Amendment 2026-06-01 — Worktree lifecycle

Worktrees are ephemeral, created per run and removed at run end (cleanup fires even on abort/failure). Clarifies sub-decision 4; does not reverse it.
