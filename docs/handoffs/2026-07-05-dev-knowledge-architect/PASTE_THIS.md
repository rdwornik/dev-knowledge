...
| Field | Value |
|---|---|
| **Slug** | `2026-07-05-dev-knowledge-architect` |
...
| **Generated at** | Bundle cut by `scripts/gen_handoff.py` from **committed** repo state on branch `docs/2026-07-05-overnight-wrap`. This line names only which branch was checked out — it states **no** sha, count, or verdict. **Re-derive HEAD / tree-clean / branch / ahead-behind live** (`PROBES.md` P3). |
...
# Residual — 2026-07-05-dev-knowledge-architect — the part the repo does not already encode
...
>
> **Branch note.** This bundle was generated on branch `docs/2026-07-05-overnight-wrap`. This line names only *which*
