...
| Field | Value |
|---|---|
| **Slug** | `2026-06-12-dev-knowledge-architect` |
| **Mode** | **architect** (v5 §13 — planning / way-of-working scope) |
| **Purpose** | Finish the **v5 handoff machinery deferred at the #149 flip** — #163 teeth validator · #164 generator (now the *no-per-bundle-README* generator), with #156/#159/#161/#162/#165 + the Q9 automation-writer-vs-`--no-ff` reconciliation beside. |
| **Generated at** | HEAD `66d0293`, working tree clean, `main` **in sync** with `origin/main` (re-derive at read-time — P3). |
...
7. Hand `RESIDUAL.md` (drift-flags first) and run the rest of `PROBES.md` (P2–P7). Any probe
   FAIL blocks onboarding (the escalation ladder).
