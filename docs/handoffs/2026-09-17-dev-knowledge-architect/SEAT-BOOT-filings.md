# SEAT-BOOT-filings — 2026-09-17-dev-knowledge-architect
...
<!-- GENERATED by scripts/gen_seat_boot.py from protocols/PLAYBOOK.md Ch8.
     ...
     seat: filings | batch: 2026-09-17-dev-knowledge-architect | date: 2026-09-17 | model: opus | ch8-sha256: 02da7cb69a9d
...
*Runs:* classification and the wave close -- judgment about what a finding IS, which is the work that does not survive a cheaper tier.

*Hands off / escalates:* A finding with no standing classification is an OPERATOR question (ADR-108 SA routes functional questions to the operator).
