...
| the bundle's `HANDOFF_BOOT.md` | **You** | The bundle's "start here": names slug · purpose · mode, points at this runbook + `PASTE_THIS.md`, and carries the resident **Operator-facing forms** card — dispatch · worktree entry · `/lane-integrate` · the teardown four-step (HANDOFF_PROCESS v7.1.0). Never pasted. |
