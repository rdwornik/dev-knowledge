...
| the bundle's `HANDOFF_BOOT.md` | **You** | The bundle's "start here": names slug · purpose · mode, points at this runbook + `PASTE_THIS.md`, and carries the resident **Operator-facing forms** card — dispatch · worktree entry · `/lane-integrate` · the teardown four-step (HANDOFF_PROCESS v6.3.0). Never pasted. |
...
- `protocols/HANDOFF_BOOT.md` — the resident browser role file (installed once as the browser
  project's instructions; `PASTE_THIS.md` carries only its PIN — v6.3.0)
