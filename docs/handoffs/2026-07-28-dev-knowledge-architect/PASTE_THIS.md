...
| Field | Value |
|---|---|
| **Slug** | `2026-07-28-dev-knowledge-architect` |
| **Chat title** | `[dev-knowledge] Technical Architect — 2026-07-28-dev-knowledge-architect · SEQ 1` — name the fresh browser chat this (bump `SEQ` per parallel chat) |
...
>
> **Branch note.** This bundle was generated on branch `docs/window-close-2026-07-28`. This line names only *which*
