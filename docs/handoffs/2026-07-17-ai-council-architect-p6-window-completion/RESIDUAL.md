...
- **The two hub NEEDS-RULING intakes (§3b)** are hub-tracked (#341 codex-producer, #344 session-close-gate) — a **hub** session's ruling; use the interim fallback (§3c) meanwhile.
