...
enforcement-in-effect (not presence) on a real gated-mesh branch->edit->commit->wrap arc, with the
...
closure proof (C4) is the discrimination between a frozen arc-green fixture (the gated set engaged) and a
