...
**71 organs across 8 classes.**

**Coverage:** agent 3 · command 12 · skill 3 · workflow 1 · rule 2 · session-hook 15 · git-hook 34 · plugin 1
...
| `SessionStart: logs_retention.py` | session-hook | SessionStart | `.claude/settings.json` | hub | ARMED |
...
| `decision-coverage` | git-hook | pre-commit | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `derived-copies-rebind` | git-hook | pre-commit | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `dispatch-conformance` | git-hook | pre-commit | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `doc-counts-pytest-freshness` | git-hook | pre-commit | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `graph-edge-class-census` | git-hook | pre-commit | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `graph-orphan-census` | git-hook | pre-commit | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `graph-process-list` | git-hook | pre-commit | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `graph-rebuild` | git-hook | pre-commit | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `graph-task-coverage` | git-hook | pre-commit | `.pre-commit-config.yaml` | pre-commit | ARMED |
