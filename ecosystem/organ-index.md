...
**78 organs across 8 classes.**

**Coverage:** agent 3 · command 14 · skill 4 · workflow 1 · rule 2 · session-hook 17 · git-hook 36 · plugin 1
...
| Name | Class | Trigger | Source | Distribution | Status |
|---|---|---|---|---|---|
| `aj-scan` | skill | model-invoke | `.claude/skills/aj-scan/SKILL.md` | hub | ARMED |
...
| `SessionStart: quota_daily.py` | session-hook | SessionStart | `.claude/settings.json` | hub | ARMED |
