...
**Coverage:** agent 3 · command 12 · skill 3 · workflow 1 · rule 2 · session-hook 14 · git-hook 36 · plugin 1
...
| `backlog-filing-backpressure` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `backlog-id-on-close` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit · deployed | ARMED |
...
| `claude-rosters-freshness` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `codemap-freshness` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit · deployed | ARMED |
| `coherence-nudge` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `commit-message-type-prefix` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
...
| `dispatch-conformance` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
...
| `impacted-tests-guard` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `intake-index-freshness` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
...
| `provider-registry-agreement` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `quality-requirements-freshness` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `roster-freshness` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
| `row-archive-proof` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
...
| `validate-hermetization` | git-hook | manual | `.pre-commit-config.yaml` | pre-commit | ARMED |
