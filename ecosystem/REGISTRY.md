...
| `ai-council` | `C:\Users\1028120\Documents\Dev\ai-council` | Multi-model AI debate and research tool for architectural decision-making across the dev ecosystem; produces binding ADRs governing all `Dev/` repos; standalone CLI consumed via the `council` entry point. | registered · onboarded (v1.2.0) |
