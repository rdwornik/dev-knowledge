# LANE RL — Provider-registry truth-up (presence-only) · filings · D3 disposition · MEMORY surface check
...
- **Scope:** registry truth-up · filings · D3 disposition · D2 filing · MEMORY surface check +
  conditional compaction. Nothing else.
...
- **Failure mode:** writing outside `ecosystem/`, `LESSONS.md`, `protocols/PLAYBOOK.md`,
  `protocols/HANDOFF_PROCESS.md` (+ `MEMORY.md` only if step 4 proves it repo-owned).
