...
`VISION.md` is superseded, retained and still tracked ([#614]). The ADR-114
...
| Living | `README.md`, `VISION` (superseded by README, still tracked — ADR-114), `ARCHITECTURE`, `CLAUDE.md`, `AGENTS.md`, `PLAYBOOK`, `ESSENTIALS` | update in place when reality shifts |
