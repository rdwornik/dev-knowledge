...
**Changes:** NEW `docs/audits/2026-06-20-removal-closure-spike-findings.md` (single design doc, §§1–9 + verdict, no live counters per #198 merge-collision lesson), this `JOURNAL.md`. Branch `docs/removal-closure-spike-196` off `worktree-196-closure-spike` (== `main` tip `ea4e23d`); `--no-ff` merge to `main` owed **from the primary repo** (NOT `/ship` in this worktree — it refuses; seed-state-yaml lesson).
