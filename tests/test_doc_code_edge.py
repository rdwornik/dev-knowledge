...
def test_edge_check_registered_and_resolves_starter_set():
    """Registered in ALL_CHECKS (count 26) AND the LIVE hub scan resolves the post-#202 set over
...
def test_coverage_drift_guard_registered_and_clean_on_live_repo():
    """The drift-guard is in ALL_CHECKS (count 26) and PASSES on the live repo: every member is
