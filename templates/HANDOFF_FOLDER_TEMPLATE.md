...
Content:
- How to use: open new browser chat, upload all files in this folder,
  paste `00_first-message.md` content as first message
- What's in the folder: file list with one-line purpose each
- Handoff metadata: type, date, target repo, generated by

### 00_first-message.md

Purpose: Copy-paste content for Browser-2's first message.
